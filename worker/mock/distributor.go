...
// Source: github.com/fsobh/auth/worker (interfaces: TaskDistributor)
//
...
import (
	...
	worker "github.com/fsobh/auth/worker"
...
func (m *MockTaskDistributor) DistributeTaskSendVerifyEmail(ctx context.Context, payload *worker.PayloadSendVerifyEmail, option ...asynq.Option) error {
	m.ctrl.T.Helper()
...
func (mr *MockTaskDistributorMockRecorder) DistributeTaskSendVerifyEmail(ctx, payload any, option ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, payload}, option...)
